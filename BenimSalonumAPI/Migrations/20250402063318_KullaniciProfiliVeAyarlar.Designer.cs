...
namespace BenimSalonumAPI.Migrations
{
    ...
    [Migration("20250402063318_KullaniciProfiliVeAyarlar")]
    partial class KullaniciProfiliVeAyarlar
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BenimSalonum.Entities.Tables.FirmaTable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BenimSalonum.Entities.Tables.KullaniciAyarlarTable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("OtomatikKilitlemeAktif")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);

                    b.Property<int>("OtomatikKilitlemeSuresi")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(15);
                    ...
                    b.Property<int>("RandevuHatirlatmaZamani")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(60);

                    b.Property<bool>("SMSBildirimAktif")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);
                    ...
                    b.Property<bool>("UygulamaIciBildirimAktif")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);
                    ...
                    b.ToTable("KullaniciAyarlar", (string)null);
                });
            ...
            modelBuilder.Entity("BenimSalonum.Entities.Tables.KullaniciTable", b =>
                {
                    ...
                    b.Property<string>("IkiFaktorluDogrulamaAnahtari")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<bool>("IkiFaktorluKimlikDogrulama")
                        .HasColumnType("bit");
                    ...
                    b.Property<DateTime?>("SifreDegistirmeTarihi")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("BenimSalonum.Entities.Tables.LisansTable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("AktivasyonAnahtari")
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");
                    ...
                    b.Property<int>("KalanKontrolGunu")
                        .HasColumnType("int");

                    b.Property<int>("KullaniciSayisiLimiti")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BenimSalonum.Entities.Tables.KullaniciAyarlarTable", b =>
                {
                    b.HasOne("BenimSalonum.Entities.Tables.KullaniciTable", "Kullanici")
                        .WithMany()
            ...
            modelBuilder.Entity("BenimSalonum.Entities.Tables.KullaniciTable", b =>
                {
                    b.HasOne("BenimSalonum.Entities.Tables.FirmaTable", "Firma")
                        .WithMany("Kullanicilar")
                        .HasForeignKey("FirmaId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("BenimSalonum.Entities.Tables.KullaniciTable", "Yonetici")
                        .WithMany()
