...
{
    public class SiparisDetayTableMap : IEntityTypeConfiguration<SiparisDetayTable>
    {
        public void Configure(EntityTypeBuilder<SiparisDetayTable> builder)
        {
            // Primary Key
            builder.HasKey(e => e.Id);
            
            // Foreign Keys
            builder.HasIndex(e => e.SiparisId)
                   .HasName("IX_SiparisDetay_SiparisId");
                   
            builder.HasIndex(e => e.StokId)
                   .HasName("IX_SiparisDetay_StokId");
                   
            // Zorunlu alanlar
            builder.Property(e => e.SiparisId)
                   .IsRequired();
            ...
            builder.Property(e => e.EticaretUrunKodu)
                   .HasMaxLength(100);
                   
            builder.Property(e => e.EticaretSepetItemId)
                   .HasMaxLength(36);
            ...
            builder.Property(e => e.KarsilananMiktar)
                   .HasColumnType("decimal(18,3)")
                   .HasDefaultValue(0);
